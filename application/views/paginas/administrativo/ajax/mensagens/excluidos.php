        ...
        <table class="table table-condensed">
            ...
            foreach ($mensagens as $row)
            {
                ...
                <tr class="inbox">
                    ...
                    <td class="inbox-data <?php
                    if ($row->foi_lida == 1){echo 'bold';}?>" data-id='<?php echo $row->id ?>'><em><?php echo date('d/m/Y H:m', strtotime($row->data)) ?></em></td>
                    <td class="inbox-titulo <?php if ($row->foi_lida == 1){echo 'bold';}?>" data-id='<?php echo $row->id ?>'><?php echo $row->titulo ?></td>
                    <td class="inbox-mensagem <?php if ($row->foi_lida == 1){echo 'bold';}?>" data-id='<?php echo $row->id ?>'>
                            <?php
