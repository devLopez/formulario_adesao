...
<script type="text/javascript">
    ...
    $(document).ready(function() {
         ...
         */
        $('.buttonNext, .buttonPrevious, .buttonFinish').click(function() {
            $('html, body').animate({
    ...
    /** Função que irá finalizar a edição, enviando para o banco de dados **/
    function finalizar()
    {
        $.ajax({
            url: '<?php echo app_baseurl().'painel/nova_solicitacao/atualizar_dados' ?>',
            type: 'POST',
            data: {
                id_pessoais: $('#id_pessoais').val(),
                id_profissionais: $('#id_profissionais').val(),
                id_conjuge: $('#id_conjuge').val(),
            ...
            success: function(sucesso)
            {
                ...
                if (sucesso.pessoais == true || sucesso.profissionais == true)
                {
                    $.SmartMessageBox({
                        title: '<i class="fa fa-thumbs-up" style="color:green;"></i> Sucesso',
                        content: '<p><strong>Os seus dados foram atualizados.</strong></p>',
                        buttons: '[Visualizar meus dados]'
                    }, function(e) {
                        if (e == "Visualizar meus dados")
                        {
                ...
                else
                {
                    $.smallBox({
                        ...
                        content: "<strong>Por algum motivo os seus dados não foram atualizados. Tente novamente</strong>",
                    ...
                    <?php
                        if(empty($pessoais))
                        {
                            ...
                            <div class="alert alert-block info">
                                Ocorreu um erro na busca dos seus dados
                            </div>
                            <?php
                        }
                        else
                        {
                            ...
                            {
                                ?>
                                <input type="hidden" id="id_pessoais" value="<?php echo $row->id ?>">
                                <div class="control-group">
                                    <label for="nome_pai"><strong>Nome do Pai:</strong></label>
                                    <div class="controls">
                                        <input class="span5" type="text" id="nome_pai" name="nome_pai" value="<?php echo $row->nome_pai ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="nome_mae"><strong>Nome da Mãe:</strong></label>
                                    <div class="controls">
                                        <input class="span5" type="text" id="nome_mae" name="nome_mae" value="<?php echo $row->nome_mae ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="data_nascimento"><strong>Data de nascimento:</strong></label>
                                    <div class="controls">
                                        <input class="span5 datas" type="text" id="data_nascimento" name="data_nascimento" value="<?php echo $row->data_nascimento ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="numero_identidade"><strong>Número da identidade</strong> (<small>Somente pontos e números</small>):</label>
                                    <div class="controls">
                                        <input class="span5" type="text" id="numero_identidade" name="numero_identidade" value="<?php echo $row->identidade ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="orgao_emissor"><strong>Orgão emissor/ estado:</strong></label>
                                    <div class="controls">
                                        <input class="span5 or_e" type="text" id="orgao_emissor" name="orgao_emissor" value="<?php echo $row->orgao_emissor ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="data_emissao"><strong>Data de emissão:</strong></label>
                                    <div class="controls">
                                        <input class="span5 datas" type="text" id="data_emissao" name="data_emissao" value="<?php echo $row->data_emissao ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="naturalidade_estado"><strong>Naturalidade:</strong></label>
                                    <div class="controls">
                                        <input class="span5" type="text" id="naturalidade_estado" name="naturalidade_estado" value="<?php echo $row->naturalidade_estado ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5" type="text" id="numero_dependentes" name="numero_dependentes" value="<?php echo $row->numero_dependentes ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="endereco_residencial"><strong>Endereço residencial:</strong></label>
                                    <div class="controls">
                                        <input class="span5" type="text" id="endereco_residencial" name="endereco_residencial" value="<?php echo $row->endereco_residencial ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="numero_residencia"><strong>Numero</strong> (<small>somente o número</small>):</label>
                                    <div class="controls">
                                        <input class="span5" type="text" id="numero_residencia" name="numero_residencia" value="<?php echo $row->numero_residencia ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="complemento_residencia"><strong>Complemento:</strong></label>
                                    <div class="controls">
                                        <input class="span5" type="text" id="complemento_residencia" name="complemento_residencia" value="<?php echo $row->complemento_residencia ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="bairro"><strong>Bairro:</strong></label>
                                    <div class="controls">
                                        <input class="span5" type="text" id="bairro" name="bairro" value="<?php echo $row->bairro ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="cidade"><strong>Cidade:</strong></label>
                                    <div class="controls">
                                        <input class="span5" type="text" id="cidade" name="cidade" value="<?php echo $row->cidade ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="cep"><strong>CEP:</strong></label>
                                    <div class="controls">
                                        <input class="span5 cep" type="text" id="cep" name="cep" value="<?php echo $row->cep ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5" type="text" id="anos_residencia" name="anos_residencia" value="<?php echo $row->anos_residencia ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="telefone"><strong>Telefone p/ contato:</strong></label>
                                    <div class="controls">
                                        <input class="span5 fone" type="text" id="telefone" name="telefone" value="<?php echo $row->telefone ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="celular"><strong>Celular:</strong></label>
                                    <div class="controls">
                                        <input class="span5 fone" type="text" id="celular" name="celular" value="<?php echo $row->celular ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label for="email"><strong>Endereço de correio eletrônio (e-mail):</strong></label>
                                    <div class="controls">
                                        <input class="span5" type="email" id="email" name="email" value="<?php echo $row->email ?>">
                                    </div>
                                </div>
                                <?php
                            }
                ...
                <div id="step-2">
                    ...
                    <?php
                        if(empty($profissionais))
                        {
                            ?>
                            <div class="alert alert-block info">
                                Ocorreu um erro na b<input type="hidden" id="id_pessoais" value="<?php echo $row->id ?>">usca dos seus dados
                            </div>
                            <?php
                        }
                        else
                        {
                            ...
                            {
                                ?>
                                <input type="hidden" id="id_profissionais" value="<?php echo $row->id ?>">
                                <div class="control-group">
                                    <label class="control-label"><strong>Profissão:</strong></label>
                                    <div class="controls">
                                        <input class="span5" type="text" id="profissao" name="profissao" value="<?php echo $row->profissao ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5 datas" type="text" id="data_admissao" name="data_admissao" value="<?php echo $row->data_admissao ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5 renda" type="text" id="salario" name="salario" value="<?php echo $row->salario ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5 renda" type="text" id="valor_outras_rendas" name="valor_outras_rendas" value="<?php echo $row->valor_outras_rendas ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5 renda" type="text" id="renda_mensal_familiar" name="renda_mensal_familiar" value="<?php echo $row->renda_mensal_familiar ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5" type="text" id="nome_empresa" name="nome_empresa" value="<?php echo $row->nome_empresa ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5 cnpj" type="text" id="cnpj_empresa" name="cnpj_empresa" value="<?php echo $row->cnpj_empresa ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5" type="text" id="tempo_empresa" name="tempo_empresa" value="<?php echo $row->tempo_empresa ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5" type="text" id="endereco_empresa" name="endereco_empresa" value="<?php echo $row->endereco_empresa ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5" type="text" id="numero_empresa" name="numero_empresa" value="<?php echo $row->numero_empresa ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5" type="text" id="complemento_empresa" name="complemento_empresa" value="<?php echo $row->complemento_empresa ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5" type="text" id="bairro_empresa" name="bairro_empresa" value="<?php echo $row->bairro_empresa ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5 cep" type="text" id="cep_empresa" name="cep_empresa" value="<?php echo $row->cep_empresa ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5" type="text" id="cidade_empresa" name="cidade_empresa" value="<?php echo $row->cidade_empresa ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5 fone" type="text" id="telefone_empresa" name="telefone_empresa" value="<?php echo $row->telefone_empresa ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5" type="text" id="cargo_empresa" name="cargo_empresa" value="<?php echo $row->cargo_empresa ?>">
                                    </div>
                                </div>
                                <?php
                            }
                ...
                <div id="step-3">
                    ...
                    <?php
                        if(!empty($conjuge))
                        {
                            ...
                            {
                                ?>
                                <input type="hidden" id="id_conjuge" value="<?php echo $row->id ?>">
                                <div class="control-group">
                                    <label><strong>Nome:</strong></label>
                                    <div class="controls">
                                        <input class="span5" type="text" id="nome_conjuge" name="nome_conjuge" value="<?php echo $row->nome_conjuge ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5 cpf" type="text" id="cpf_conjuge" name="cpf_conjuge" value="<?php echo $row->cpf_conjuge ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5" type="text" id="identidade_conjuge" name="identidade_conjuge" value="<?php echo $row->identidade_conjuge ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5 datas" type="text" id="data_expedicao_conjuge" name="data_expedicao_conjuge" value="<?php echo $row->data_expedicao_conjuge ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5 or_e" type="text" id="orgao_emissor_conjuge" name="orgao_emissor_conjuge" value="<?php echo $row->orgao_emissor_conjuge ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5 datas" type="text" id="data_nascimento_conjuge" name="data_nascimento_conjuge" value="<?php echo $row->data_nascimento_conjuge ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5" type="text" id="naturalidade_estado_conjuge" name="naturalidade_estado_conjuge" value="<?php echo $row->naturalidade_estado_conjuge ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5" type="text" id="empresa_conjuge" name="empresa_conjuge" value="<?php echo $row->empresa_conjuge ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5 cnpj" type="text" id="cnpj_empresa_conjuge" name="cnpj_empresa_conjuge" value="<?php echo $row->cnpj_empresa_conjuge ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5 datas" type="text" id="data_admissao_conjuge" name="data_admissao_conjuge" value="<?php echo $row->data_admissao_conjuge ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5" type="text" id="endereco_comercial_conjuge" name="endereco_comercial_conjuge" value="<?php echo $row->endereco_comercial_conjuge ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5" type="text" id="numero_empresa_conjuge" name="numero_empresa_conjuge" value="<?php echo $row->numero_empresa_conjuge ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    <label><strong>Complemento:</strong></label>
                                    <div class="controls">
                                        <input class="span5" type="text" id="complemento_empresa_conjuge" name="complemento_empresa_conjuge" value="<?php echo $row->complemento_empresa_conjuge ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    <label><strong>Telefone:</strong></label>
                                    <div class="controls">
                                        <input class="span5 fone" type="text" id="telefone_empresa_conjuge" name="telefone_empresa_conjuge" value="<?php echo $row->telefone_empresa_conjuge ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    <label><strong>Cargo:</strong></label>
                                    <div class="controls">
                                        <input class="span5" type="text" id="cargo_empresa_conjuge" name="cargo_empresa_conjuge" value="<?php echo $row->cargo_empresa_conjuge ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5 renda" type="text" id="salario_conjuge" name="salario_conjuge" value="<?php echo $row->salario_conjuge ?>">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span5" type="text" id="profissao_conjuge" name="profissao_conjuge" value="<?php echo $row->profissao_conjuge ?>">
                                    </div>
                                </div>
                                <?php
                            }
