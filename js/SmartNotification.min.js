...
(function($) {
    $.SmartMessageBox = function(settings, callback) {
        ...
        if (settings.musica == "") {
            ...
            if (isIE8orlower() == 0) {
                var audioElement = document.createElement("audio");
                audioElement.setAttribute("src", "sound/" + settings.musica + ".mp3");
                $.get();
                audioElement.addEventListener("load", function() {
                    audioElement.play()
                }, true);
        ...
        if (settings.input != undefined) {
            ...
            switch (settings.input) {
                ...
                case "password":
                    ...
                    break;
                case "email":
                	InputType = "<input class='form-control' type='" + settings.input + "' id='txt" + SmartMSGboxCount +"' placeholder='" + settings.placeholder + "' required autofocus><br/><br/>";
                	break;
                case "select":
